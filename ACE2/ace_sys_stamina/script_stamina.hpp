#define ACE_STAMINA_LVL_0 1.3 // CIVILIAN //
#define ACE_STAMINA_LVL_1 1.2 // INSURGENT //
#define ACE_STAMINA_LVL_2 1.0 // ARMY // Data is based off regular Army
#define ACE_STAMINA_LVL_3 0.8 // SPECIAL FORCES //
