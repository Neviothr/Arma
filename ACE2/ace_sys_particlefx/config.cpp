...
class CfgCloudlets
{
	...
	class ACE_GrenadeSmoke1_Practice: GrenadeSmoke1
	{
		...
		color[]=
		{
			{0.89999998,0.40000001,0,1},
			{0.89999998,0.40000001,0,0.5},
			{0.89999998,0.44999999,0,0.25},
			{1,0.5,0,0}
		};
	};
	...
	class ACE_FX_API_ImpactSmoke: Default
	{
		...
		size[]={0.5,0.69999999,1};
		color[]=
		{
			{0.60000002,0.60000002,0.60000002,0.60000002},
			{0.64999998,0.64999998,0.64999998,0.40000001},
			{0.75,0.75,0.75,0.25},
			{0.80000001,0.80000001,0.80000001,0.1},
			{0.85000002,0.85000002,0.85000002,0}
		};
		colorCoef[]={1,1,1,1};
		animationSpeed[]={1};
		position[]={0,0,0};
		positionVar[]={0.2,0.2,0.2};
		moveVelocityVar[]={0.1,0.40000001,0.1};
	...
	class ACE_FX_API_ExpSparks: Default
	{
		...
		volume=7.9000001;
		rubbing=70;
		size[]={0.02,0.02,0.02,0.015,0.0099999998,0.0080000004,0.0080000004,0.0049999999,0.003,0};
		color[]=
		{
			{3,1,1,-50}
		};
	...
	class ACE_ImpactDust: Default
	{
		...
		moveVelocity[]=
		{
			"surfNormalX * (0.2+(intensity*2))",
			"surfNormalY * (.2+(intensity*.4))",
			"surfNormalZ * (0.2+(intensity*2))"
		};
		moveVelocityVar[]=
		{
			".2+(intensity*.5)",
		...
		color[]=
		{
			{0.85000002,0.73000002,0.76999998,0.15000001},
			{0.75,0.74000001,0.70999998,0}
		};
		colorCoef[]={1,1,1,1};
	...
	class ACE_LingeringDust: ACE_ImpactDust
	{
		...
		color[]=
		{
			{0.85000002,0.73000002,0.67000002,0.15000001},
			{0.85000002,0.73000002,0.67000002,0.15000001},
			{0.85000002,0.73000002,0.67000002,0.13},
			{0.75,0.74000001,0.70999998,0.1},
			{0.75,0.74000001,0.70999998,0.079999998},
			{0.75,0.74000001,0.70999998,0}
		};
	};
	class ACE_ImpactDustDirt: Default
	{
		...
		color[]=
		{
			{0.34999999,0.23,0.07,1},
			{0.34999999,0.23,0.0099999998,0}
		};
		colorCoef[]=
		{
			"1 + 0.02 * dustColor",
	...
	class ACE_ImpactDustDust: Default
	{
		...
		color[]=
		{
			{0.55000001,0.43000001,0.27000001,1},
			{0.55000001,0.43000001,0.27000001,0.89999998},
			{0.64999998,0.52999997,0.37,0.1},
			{0.64999998,0.52999997,0.37,0}
		};
		colorCoef[]=
		{
			"1 + 0.02 * dustColor",
...
class ace_pfx_ammo_heat_120mm
{
	...
	class GrenadeSmoke1
	{
		...
		position[]=
		{
			"(((random 0.5) - (random 0.5)) - ((random 0.5) - (random 0.5)))",
			"(((random 0.5) - (random 0.5)) - ((random 0.5) - (random 0.5)))",
			"(((random 0.5) - (random 0.5)) - ((random 0.5) - (random 0.5)))"
		};
...
class ACE_FX_SABOT120_ImpactMetal
{
	...
	class ImpactSparks1
	{
		simulation="particles";
		type="ImpactSparks1";
		position[]={0.050000001,0.050000001,0.050000001};
		intensity=1;
		interval=0.40000001;
		lifeTime=1.3;
	};
	class ImpactSparks2
	{
		simulation="particles";
		type="ImpactSparks2";
		position[]={0.0099999998,0.0099999998,0.0099999998};
		intensity=1;
		interval=0.40000001;
		lifeTime=1.6;
	};
	...
	class ImpactSparks4
	{
		simulation="particles";
		type="ImpactSparks2";
		position[]={0.079999998,0.079999998,0.079999998};
		intensity=1.1;
		interval=0.40000001;
		lifeTime=1.5;
	};
...
class CfgWeapons
{
	...
	class M242: CannonCore
	{
		...
		{
			shape="ca\data\cl_exp";
			timerPeriod=0.075000003;
			lifeTime=0.075000003;
			position[]={0,0.050000001,0};
			size[]={0,0.89999998,1.2};
			color[]=
			{
				{1,1,1,-2},
				{0.89999998,0.89999998,0.89999998,-1},
