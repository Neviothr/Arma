...
class CfgSounds
{
	class ACE_VERSION_DING
	{
		...
		sound[]=
		{
			"\x\ace\addons\main\sound\ace_version_ding.ogg",
			"db+10",
			1
		};
		titles[]={};
...
class ACE_MenuRscShortcutButton: RscShortcutButton
{
	...
	colorDisabled[]={0.94999999,0.94999999,0.94999999,0.25};
	class HitZone
	{
		left=0;
		top=0;
...
class ACE_ABOUT_CTRL: RscActiveText
{
	...
	colorActive[]={0.54299998,0.57419997,0.4102,1};
	text="About";
	onButtonClick="";
};
...
class ACE_VERSION_MISMATCH
{
	...
	controls[]=
	{
		"ACE_VERSION_MISMATCH_BG",
		"ACE_VERSION_MISMATCH_TITLE",
		"ACE_VERSION_MISMATCH_TEXT",
		"ACE_VERSION_MISMATCH_BUTT",
		"ACE_VERSION_MISMATCH_LINE",
		"ACE_VERSION_MISMATCH_HTML",
		"ACE_VERSION_MISMATCH_LINE2"
	};
...
class ACE_DBC_RscGroupBox2
{
	...
	style=112;
	text="";
	colorBackground[]={1,1,1,0.60000002};
	colorText[]={0,0,0,0};
	font="BitStream";
	sizeEx=0.02;
};
class ACE_MP_Debug_Console
{
	...
	class Controls
	{
		...
		class SubBackground1: ACE_DBC_RscGroupBox2
		{
			...
			h=0.41;
			style=128;
			colorBackground[]={0.70899999,0.972,0.384,0.2};
		};
...
class RscTitles
{
	...
	class ACE_ProgressBar
	{
		...
		class ACE_ProgressBar: ACE_Progressbar_RscText
		{
			...
			h=0.013;
			w=0;
			colorBackground[]={0.54299998,0.57419997,0.4102,0.80000001};
		};
...
class ACE_Config
{
	class ace_pbos
	{
		...
		ace_pbos[]=
		{
			"ace_anims_fastswitch",
			"ace_anims_movement",
			"ace_anims_reload",
			"ace_anims_turn",
			"ace_anims_weaponsway",
			"ace_sys_backblast",
			"ace_sys_combatdeaf",
			"ace_sys_muzzleblast",
			"ace_sys_mv",
			"ace_sys_recognize",
			"ace_sys_rotoreffects",
			"ace_sys_stamina",
			"ace_sys_vehicledamage",
			"ace_sys_wind_deflection",
			"ace_sys_wounds"
		};
	};
};
...
class CfgVehicles
{
	...
	class ACE_DummyManBase: Man
	{
		...
		vegetation0[]=
		{
			"Ca\sounds\Characters\Noises\Bush\bush1",
			1,
			1,
			20
		};
		vegetation1[]=
		{
			"Ca\sounds\Characters\Noises\Bush\bush2",
			1,
			1,
			20
		};
		vegetation2[]=
		{
			"Ca\sounds\Characters\Noises\Bush\bush3",
			1,
			1,
			20
		};
...
class CfgFontFamilies
{
	class ACE_DIGIT
	{
		fonts[]=
		{
			"\x\ace\addons\main\Data\Fonts\digit\Digit8",
			"\x\ace\addons\main\Data\Fonts\digit\Digit10",
			"\x\ace\addons\main\Data\Fonts\digit\Digit12",
			"\x\ace\addons\main\Data\Fonts\digit\Digit13",
			"\x\ace\addons\main\Data\Fonts\digit\Digit14",
			"\x\ace\addons\main\Data\Fonts\digit\Digit16",
			"\x\ace\addons\main\Data\Fonts\digit\Digit18",
			"\x\ace\addons\main\Data\Fonts\digit\Digit20"
		};
		spaceWidth=0.89999998;
		spacing=0.039999999;
	};
	class ACE_HANDWRITTEN
	{
		fonts[]=
		{
			"\x\ace\addons\main\Data\Fonts\handwritten\Journal8",
			"\x\ace\addons\main\Data\Fonts\handwritten\Journal10",
			"\x\ace\addons\main\Data\Fonts\handwritten\Journal12",
			"\x\ace\addons\main\Data\Fonts\handwritten\Journal13",
			"\x\ace\addons\main\Data\Fonts\handwritten\Journal14",
			"\x\ace\addons\main\Data\Fonts\handwritten\Journal16",
			"\x\ace\addons\main\Data\Fonts\handwritten\Journal18",
			"\x\ace\addons\main\Data\Fonts\handwritten\Journal20"
		};
		spaceWidth=0.89999998;
		spacing=0.039999999;
	};
