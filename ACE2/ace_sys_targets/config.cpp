...
class CfgVehicles
{
	...
	class ACE_Hostage_Target_1: ACE_TargetBase
	{
		...
		{
			"\x\ace\addons\sys_targets\data\blackhos_co.paa"
		};
	};
	class ACE_Hostage_Target_2: ACE_Hostage_Target_1
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\x\ace\addons\sys_targets\data\brownhos_co.paa"
		};
	};
	class ACE_Hostage_Target_3: ACE_Hostage_Target_1
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\x\ace\addons\sys_targets\data\greenhos_co.paa"
		};
	};
	class ACE_Hostage_Target_4: ACE_Hostage_Target_1
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\x\ace\addons\sys_targets\data\redhos_co.paa"
		};
	};
	class ACE_Hostage_Target_5: ACE_Hostage_Target_1
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\x\ace\addons\sys_targets\data\tanhos_co.paa"
		};
	};
	class ACE_Hostage_Target_6: ACE_Hostage_Target_1
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\x\ace\addons\sys_targets\data\whitehos_co.paa"
		};
	};
	class ACE_Box_Target_1: ACE_TargetBase
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\x\ace\addons\sys_targets\data\greenfacumc_co.paa"
		};
	};
	class ACE_Box_Target_2: ACE_Box_Target_1
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\x\ace\addons\sys_targets\data\brownfacumc_co.paa"
		};
	};
	class ACE_Box_Target_3: ACE_Box_Target_1
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\x\ace\addons\sys_targets\data\facumc_co.paa"
		};
	};
	...
	class ACE_Tac_Target_1: ACE_TargetBase
	{
		...
		{
			"",
			"\x\ace\addons\sys_targets\data\ace_tac_1_ca.paa"
		};
	};
	class ACE_Tac_Target_2: ACE_Tac_Target_1
	{
		...
		{
			"",
			"\x\ace\addons\sys_targets\data\ace_tac_2_ca.paa"
		};
	};
	class ACE_Tac_Target_3: ACE_Tac_Target_1
	{
		...
		{
			"",
			"\x\ace\addons\sys_targets\data\ace_tac_3_ca.paa"
		};
	};
