...
class CfgMovesMaleSdr: CfgMovesBasic {
	class States {
		...
		class ACE_LauncherProne: Default {
			...
			connectTo[] = {};
			connectFrom[] = {};
			interpolateFrom[] = {"ACE_LauncherProne", 0.039999999};
			interpolateTo[] = {"ACE_LauncherProne", 0.039999999};
			enableBinocular = 1;
			preload = 0;
		...
		class ACE_LauncherKneel_LauncherProne: TransAnimBase {
			...
			soundEnabled = 1;
			enableMissile = 1;
			interpolateFrom[] = {"AmovPknlMstpSrasWlnrDnon", 0.0099999998};
			interpolateTo[] = {"ACE_LauncherProne", 0.0099999998};
		};
		class ACE_LauncherProne_LauncherKneel: TransAnimBase {
			...
			weaponIK = 4;
			interpolateFrom[] = {"ACE_LauncherProne", 0.0099999998};
			interpolateTo[] = {"AmovPknlMstpSrasWlnrDnon", 0.0099999998};
		};
		class ACE_RifleProne_LauncherProne: TransAnimBase {
			...
			leaningFactorBeg = 1;
			leaningFactorEnd = 0.5;
			interpolateFrom[] = {"AmovPpneMstpSrasWrflDnon", 0.0099999998};
			interpolateTo[] = {"ACE_LauncherProne", 0.0099999998};
			weaponIK = 4;
			onLandBeg = 1;
			onLandEnd = 1;
		...
		class ACE_LauncherProne_RifleProne: TransAnimBase {
			...
			leaningFactorEnd = 0;
			interpolateFrom[] = {"ACE_LauncherProne", 0.0099999998};
			interpolateTo[] = {"AmovPpneMstpSrasWrflDnon", 0.0099999998};
			weaponIK = 4;
			onLandBeg = 1;
			onLandEnd = 1;
		};
