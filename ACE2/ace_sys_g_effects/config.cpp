...
class CfgSounds
{
	class ACE_OverGLimit_US
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_g_effects\data\sounds\usa\GOverLimit.ogg",
			"db+10",
			1
		};
		titles[]={};
	...
	class ACE_MaximumG_US
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_g_effects\data\sounds\usa\MaximumG.ogg",
			"db+10",
			1
		};
		titles[]={};
	...
	class ACE_OverGLimit_RU
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_g_effects\data\sounds\rus\GOverLimit.wav",
			"db+10",
			1
		};
		titles[]={};
	...
	class ACE_MaximumG_RU
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_g_effects\data\sounds\rus\MaximumG.wav",
			"db+10",
			1
		};
		titles[]={};
