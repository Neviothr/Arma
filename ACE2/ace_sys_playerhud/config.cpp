	...
	class ACE_PHud_Stance
	{
		...
		class controls
		{
			class ACE_PH_StanceIndicator
			{
				...
				font="Zeppelin32";
				sizeEx=0.023;
				colorText[]={0.40000001,0.67449999,0.2784,0.69999999};
				colorBackground[]={0,0,0,0};
				text="";
			};
			...
			class G_GearItems: ACE_GDF_RscControlsGroup
			{
				...
				class Controls
				{
					...
					class ACE_IFAK_1CGDF: ACE_GDF_RscActiveText
					{
						...
						h="0.043* 0.7";
						sizeEx=0.035209998;
						color[]={0.40000001,0.67449999,0.2784,0.60000002};
						colorActive[]={0.40000001,0.67449999,0.2784,0.5};
						colorText[]={0.40000001,0.67449999,0.2784,0.5};
						text="";
					};
