...
class CfgWeapons
{
	...
	class Throw: GrenadeLauncher
	{
		...
		class ACE_FlashbangMuzzle: ThrowMuzzle
		{
			...
			sound[]=
			{
				"\x\ace\addons\sys_flashbang\grenade_pin.wss",
				0.177828,
				1,
				20
			};
...
class CfgAmmo
{
	...
	class ACE_Flashbang: SmokeShell
	{
		...
		soundDefault1[]=
		{
			"\x\ace\addons\sys_flashbang\flashbang_exp1.ogg",
			3.1622801,
			1,
			500
		};
		soundDefault2[]=
		{
			"\x\ace\addons\sys_flashbang\flashbang_exp2.ogg",
			3.1622801,
			1,
			500
		};
	...
	class ACE_Flashbang2: ACE_Flashbang
	{
		...
		soundDefault1[]=
		{
			"\x\ace\addons\sys_flashbang\flashbang2_exp2.ogg",
			1,
			1,
			500
		};
	...
	class ACE_Flashbang9: ACE_Flashbang2
	{
		...
		soundDefault1[]=
		{
			"\x\ace\addons\sys_flashbang\flashbang9_exp2.ogg",
			1,
			1,
			500
		};
