class CfgPatches
{
	class ace_c_men
	{
		units[]=
		{
			"ACE_US_Soldier_M224_G",
			"ACE_US_Soldier_M224_AG",
			"ACE_US_Soldier_M224_AB",
			"ACE_US_Soldier_M252_G",
			"ACE_US_Soldier_M252_AG",
			"ACE_US_Soldier_M252_AB",
			"ACE_TK_Soldier_KonkursG",
			"ACE_TK_Soldier_KonkursAG",
			"ACE_TK_Soldier_2B14_G",
			"ACE_TK_Soldier_2B14_AG",
			"ACE_TK_Soldier_2B14_AB",
			"ACE_TK_CIV_Takistani_Doctor_EP1",
			"ACE_CZ_Medic_EP1",
			"ACE_UN_CDF_Medic_EP1",
			"ACE_TK_INS_Soldier_AK_EP1",
			"ACE_TK_INS_Soldier_AKS_EP1"
		};
		weapons[]={};
	...
	class Goat: CAAnimalBase
	{
		class SoundEnvironExt
		{
			laydown[]=
			{
				...
				{
					"\CA\animals2\data\sounds\goat01",
					0.1,
					1,
					50
				},
				...
				{
					"\CA\animals2\data\sounds\goat03",
					0.1,
					1,
					50
				}
	...
	class Sheep: CAAnimalBase
	{
		class SoundEnvironExt
		{
			laydown[]=
			{
				...
				{
					"\CA\animals2\data\sounds\sheep02",
					0.1,
					1,
					50
				}
