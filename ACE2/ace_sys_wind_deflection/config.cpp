...
class cfgAmmo
{
	...
	{
		ace_windcoef=0.40000001;
	};
	class B_545x39_Ball: BulletBase
	{
		ace_windcoef=0.55000001;
	};
	...
	{
		ace_windcoef=0.44999999;
	};
	class B_127x99_Ball: BulletBase
	{
		ace_windcoef=0.23999999;
	};
...
class RscTitles
{
	class ACE_RscWindIntuitive
	{
		...
		controls[]=
		{
			"ACE_RscWindIntuitive_BG",
			"ACE_RscWindIntuitive_1"
		};
