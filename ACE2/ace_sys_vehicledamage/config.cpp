...
class CfgVehicles
{
	...
	class T90: Tank
	{
		...
		ace_era_coverage_hull[]={0.89999998,0.5,0.5,0,0};
		...
		ace_era_coverage_turret[]={0.69999999,0.30000001,0.30000001,0,0.30000001};
	...
	class ACE_T90A: T90
	{
		...
		ace_era_coverage_turret[]={0.89999998,0.30000001,0.30000001,0,0.30000001};
	...
	class T72_Base: Tank
	{
		ace_minimalhit[]={40,100};
		ace_era=0;
		ace_p_detonation_hull=0.80000001;
		ace_p_detonation_turret=0.2;
		ace_p_detonation_engine=0.2;
	...
	class ZSU_Base: Tank
	{
		...
		ace_p_detonation_turret=0;
		ace_p_detonation_engine=0.2;
		ace_p_fire_hull=0.69999999;
		ace_p_fire_turret=0.69999999;
		ace_p_fire_engine=0.80000001;
		ace_p_firedetonation=0.80000001;
		ace_armor_hull[]=
		{
			{10,10},
			{10,10},
	...
	class 2S6M_Tunguska: Tank
	{
		ace_minimalhit[]={13,30};
		ace_era=0;
		ace_p_detonation_hull=0.40000001;
		ace_p_detonation_turret=0.40000001;
		ace_p_detonation_engine=0.40000001;
		ace_p_fire_hull=0.69999999;
		ace_p_fire_turret=0.69999999;
		ace_p_fire_engine=0.80000001;
		ace_p_firedetonation=0.80000001;
	...
	class M1A2_TUSK_MG: M1A1
	{
		...
		ace_era_coverage_hull[]={0,0.80000001,0.80000001,0.89999998,0};
	...
	class MLRS: Tank
	{
		...
		ace_firepos[]={0,0,-1};
		ace_p_detonation_hull=0.2;
		ace_p_detonation_turret=0.69999999;
		ace_p_detonation_engine=0;
		ace_p_fire_hull=0.2;
	...
	class M2A3_EP1: M2A2_EP1
	{
		...
		ace_era_coverage_hull[]={0.5,0.80000001,0.80000001,0,0};
	...
	class BAF_FV510_D: Tank
	{
		...
		ace_era_coverage_hull[]={0.2,0.80000001,0.80000001,0.40000001,0};
...
class cfgAmmo
{
	...
	class ACE_cookoff_large_1_normal: ShellBase
	{
		...
		soundHit[]=
		{
			"\x\ace\addons\sys_vehicledamage\sound\cannon_crack_close.wss",
			56.234131,
			1,
			1800
		};
	...
	class ACE_cookoff_large_1_filtered: ACE_cookoff_large_1_normal
	{
		...
		soundHit[]=
		{
			"\x\ace\addons\sys_vehicledamage\sound\cannon_crack_close_filtered.wss",
			56.234131,
			1.2,
			1800
		};
	...
	class ACE_cookoff_small_1_normal: ACE_cookoff_large_1_normal
	{
		...
		soundHit[]=
		{
			"\x\ace\addons\sys_vehicledamage\sound\heavy_crack_close.wss",
			56.234131,
			1,
			1800
		};
	...
	class ACE_cookoff_small_1_filtered: ACE_cookoff_large_1_filtered
	{
		...
		soundHit[]=
		{
			"\x\ace\addons\sys_vehicledamage\sound\heavy_crack_close_filtered.wss",
			56.234131,
			1,
			1800
		};
	...
	class ACE_cookoff_small_2_normal: ACE_cookoff_large_1_normal
	{
		...
		soundHit[]=
		{
			"\x\ace\addons\sys_vehicledamage\sound\light_crack_close.wss",
			56.234131,
			1,
			1800
		};
	...
	class ACE_cookoff_small_2_filtered: ACE_cookoff_large_1_filtered
	{
		...
		soundHit[]=
		{
			"\x\ace\addons\sys_vehicledamage\sound\light_crack_close_filtered.wss",
			56.234131,
			1,
			1800
		};
...
class CfgSounds
{
	class ace_tankpenetration
	{
		...
		sound[]=
		{
			"\ca\weapons\data\sound\explosion_big_12_vehicle_A.wss",
			10,
			1
		};
		titles[]={};
	...
	class ace_penetration_mediumcal_1
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_vehicledamage\sound\ap_hit_veh1.wss",
			10,
			1
		};
		titles[]={};
	...
	class ace_penetration_mediumcal_2
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_vehicledamage\sound\ap_hit_veh2.wss",
			10,
			1
		};
		titles[]={};
	...
	class ace_penetration_mediumcal_3
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_vehicledamage\sound\ap_hit_veh3.wss",
			10,
			1
		};
		titles[]={};
