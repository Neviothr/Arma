...
class cba_ui_canvas
{
	...
	colorText[]={0,0,0,0};
	colorSea[]={0.56,0.80000001,0.98000002,0};
	colorForest[]={0.60000002,0.80000001,0.2,0};
	colorRocks[]={0.5,0.5,0.5,0};
	colorCountlines[]={0.64999998,0.44999999,0.27000001,0};
	colorMainCountlines[]={0.64999998,0.44999999,0.27000001,0};
	colorCountlinesWater[]={0,0.52999997,1,0};
	colorMainCountlinesWater[]={0,0.52999997,1,0};
	...
	colorOutside[]={0.56,0.80000001,0.98000002,0};
	font="TahomaB";
	sizeEx=0;
	stickX[]=
	{
	...
	class CustomMark
	{
		...
		color[]={0.64709997,0.6706,0.62349999,0};
		size=18;
		importance=1;
		coefMin=1;
		coefMax=1;
	...
	class Bunker
	{
		...
		color[]={0.55000001,0.63999999,0.43000001,0};
		size=14;
	...
	class BusStop
	{
		...
		color[]={0.15000001,0.25999999,0.87,0};
		size=12;
	...
	class Fountain
	{
		...
		color[]={0.2,0.44999999,0.69999999,0};
		size=11;
	...
	{
		icon="\ca\ui\data\map_waypoint_ca.paa";
		color[]={0,0.34999999,0.69999999,0};
		size=16;
		importance="2.5 * 16 * 0.05";
		coefMin=0.5;
		coefMax=4;
	...
	class ActiveMarker
	{
		color[]={0.30000001,0.1,0.89999998,0};
		size=50;
	};
};
class rscTitles
...
class CfgSounds
{
	class ace_bombrelease
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_air_hud\sounds\bombdrop.ogg",
			3,
			1
		};
		titles[]={};
