...
class CfgSounds
{
	class ace_fx_planeABurner
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_planefx\sound\burner.ogg",
			"db+10",
			1
		};
		titles[]={};
	...
	class ace_fx_jetflybyfar
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_planefx\sound\jet_flyby1.ogg",
			"db+0",
			1
		};
		titles[]={};
	...
	class ace_fx_jetflybyshort
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_planefx\sound\plane_flyby_short.ogg",
			"db+0",
			1
		};
		titles[]={};
	...
	class ace_fx_jetflybya10
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_planefx\sound\a10_flyby.ogg",
			"db+0",
			1
		};
		titles[]={};
	...
	class ace_fx_jetflybyharrier
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_planefx\sound\harrier_flyby.ogg",
			"db-3",
			1
		};
		titles[]={};
	...
	class ace_fx_jetflybysu
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_planefx\sound\su_flyby.ogg",
			"db-3",
			1
		};
		titles[]={};
	...
	class ace_fx_sonicboom
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_planefx\sound\sonicboom.ogg",
			"db-2",
			1
		};
		titles[]={};
