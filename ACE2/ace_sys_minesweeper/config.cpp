class CfgPatches
{
	class ace_sys_minesweeper
	{
		...
		weapons[]=
		{
			...
			"ACE_APOBS_B",
			"ACE_MineMarkers",
			"ACE_MineMarkers_Light",
			"ACE_MineMarkers_PathSign",
			"ACE_MineMarkers_MineSign",
...
class CfgSounds
{
	class ace_sweep_low
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_minesweeper\sound\ace_sweep_low.ogg",
			"db+1",
			1
		};
		titles[]={};
	...
	class ace_sweep_high: ace_sweep_low
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_minesweeper\sound\ace_sweep_high.ogg",
			"db+1",
			1
		};
	};
