class CfgPatches
{
	class ace_sys_ruck
	{
		units[]=
		{
			"ACE_InvisWeaponHolder",
			"ACE_InvisWeaponHolder2",
			"ACE_RUCK_Box_Base",
			"ACE_RuckBox_West",
			"ACE_RuckBox_East",
			"ACE_RuckBox_Ind",
			"ACE_Rucksack_crate",
			"ACE_Rucksack_MOLLE_Green_crate",
			"ACE_Rucksack_MOLLE_Brown_crate",
			"ACE_Rucksack_MOLLE_Wood_crate",
			"ACE_Rucksack_MOLLE_ACU_crate",
			"ACE_Rucksack_MOLLE_WMARPAT_crate",
			"ACE_Rucksack_MOLLE_DMARPAT_crate",
			"ACE_Rucksack_MOLLE_Green_Medic_crate",
			"ACE_Rucksack_MOLLE_Brown_Medic_crate",
			"ACE_Rucksack_MOLLE_ACU_Medic_crate",
			"ACE_Rucksack_MOLLE_WMARPAT_Medic_crate",
			"ACE_Rucksack_MOLLE_DMARPAT_Medic_crate",
			"ACE_VTAC_RUSH72_crate",
			"ACE_CharliePack_crate",
			"ACE_FAST_PackEDC_crate",
			"ACE_Combat_Pack_crate",
			"ACE_Rucksack_RD90_crate",
			"ACE_Rucksack_RD91_crate",
			"ACE_Rucksack_RD92_crate",
			"ACE_Rucksack_RD54_crate",
			"ACE_Rucksack_RD99_crate",
			"ACE_Rucksack_EAST_crate",
...
class CfgVehicles
{
	...
	class ACE_Rucksack_crate: ReammoBox
	{
		...
		{
			"x\ace\addons\sys_ruck\backpack_data\np_sabot_co.paa"
		};
	...
	class CZ_Assault_Pack_Explosives_ACR: CZ_Assault_Pack_ACR
	{
		class ACE: ACE
		{
			class sys_ruck
			{
				convert[]=
				{
					"CZ_Assault_Pack_Explosives_ACR",
					"ACE_BackPack_ACR"
				};
			};
		};
		...
		class G_GearItems: RscControlsGroup
		{
			...
			class Controls
			{
				class CA_Gear_slot_primary: RscActiveText
				{
					...
					color[]={1,1,1,1};
					colorBackground[]={0.60000002,0.83920002,0.47060001,1};
					colorBackgroundSelected[]={0.60000002,0.83920002,0.47060001,1};
