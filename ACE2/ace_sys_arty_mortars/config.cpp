...
class CfgWeapons
{
	...
	class ace_arty_m224: CannonCore
	{
		...
		begin1[]=
		{
			"\x\ace\addons\sys_arty_mortars\data\sounds\60mm_1",
			"db+27",
			1,
			300
		};
		...
		reloadSound[]=
		{
			"\x\ace\addons\sys_arty_mortars\data\sounds\mortar_load_long",
			3,
			1,
			12
		};
	...
	class ace_arty_m252: ace_arty_m224
	{
		...
		begin1[]=
		{
			"\x\ace\addons\sys_arty_mortars\data\sounds\ace_mortar_fire",
			"db+27",
			1.1,
			600
		};
		...
		reloadSound[]=
		{
			"\x\ace\addons\sys_arty_mortars\data\sounds\mortar_load_short",
			3,
			1,
			8
		};
		dispersion=0.018866999;
	};
	...
	class ace_arty_120tampella: ace_arty_m252
	{
		...
		begin1[]=
		{
			"\x\ace\addons\sys_arty_mortars\data\sounds\120mm_1",
			216.228,
			1,
			800
		};
		begin2[]=
		{
			"\x\ace\addons\sys_arty_mortars\data\sounds\120mm_2",
			216.228,
			1,
			800
		};
		begin3[]=
		{
			"\x\ace\addons\sys_arty_mortars\data\sounds\120mm_5",
			216.228,
			1,
			800
		};
		begin4[]=
		{
			"\x\ace\addons\sys_arty_mortars\data\sounds\120mm_6",
			216.228,
			1,
			800
		};
...
class CfgVehicles
{
	...
	class ACE_M252: M252_US_EP1
	{
		...
		ACE_ARTY_SETUP_OFFSET_STAKEANGLE=-0.55000001;
		artilleryScanner=0;
	...
	class ACE_120Tampella_Barrel: ACE_120Tampella
	{
		...
		attachPosFront[]={0,-2.0999999,0.80000001};
	...
	class ACE_120Tampella_Baseplate: ACE_120Tampella
	{
		...
		ACE_Weight=64;
		attachPosFront[]={0,-0.60000002,0.80000001};
...
class CfgAceArtyBatteryType
{
	...
	class M252
	{
		...
		ammunition[]=
		{
			...
			"ace_arty_81mm_m853a1",
			"ace_arty_81mm_m375a3"
		};
