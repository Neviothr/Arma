class CfgPatches
{
	class ace_sys_knicklicht
	{
		units[]=
		{
			"ACE_Knicklicht_Object_Base",
			"ACE_Knicklicht_Object_R",
			"ACE_Knicklicht_Object_R_I",
			"ACE_Knicklicht_Object_G",
			"ACE_Knicklicht_Object_G_I",
			"ACE_Knicklicht_Object_W",
			"ACE_Knicklicht_Object_W_I",
			"ACE_Knicklicht_Object_Y",
			"ACE_Knicklicht_Object_Y_I",
			"ACE_Knicklicht_Object_B",
			"ACE_Knicklicht_Object_B_I",
			"ACE_KnicklichtBox"
		};
		weapons[]=
		{
...
class CfgWeapons
{
	...
	class Throw: GrenadeLauncher
	{
		...
		class ACE_KnicklichtMuzzle: ThrowMuzzle
		{
			sound[]=
			{
				"\x\ace\addons\sys_knicklicht\sound\knickknack.ogg",
				1,
				1
			};
			displayName="$STR_WDN_ACE_KNICKLICHT";
		...
		class ACE_Knicklicht_UsedMuzzle: ACE_KnicklichtMuzzle
		{
			...
			magazines[]=
			{
				"ACE_Knicklicht_R_Used",
				"ACE_Knicklicht_W_Used",
				"ACE_Knicklicht_G_Used",
				"ACE_Knicklicht_Y_Used",
				"ACE_Knicklicht_B_Used",
				"ACE_Knicklicht_IR_Used"
			};
		};
	};
	class M9;
...
class CfgVehicles
{
	...
	class ACE_Knicklicht_Object_Base: RoadBarrier_light
	{
		...
		{
			"x\ace\addons\sys_knicklicht\data\weiss_ca.paa"
		};
		class EventHandlers
		{
		};
	...
	class ACE_Knicklicht_Object_R: ACE_Knicklicht_Object_Base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"x\ace\addons\sys_knicklicht\data\rot_ca.paa"
		};
		class MarkerLights
		{
			class RedBlinking
			{
				name="licht";
				color[]={1,0.1,0.1,1};
				ambient[]={0.1,0.0099999998,0.0099999998,0.050000001};
				brightness=0.0027999999;
				blinking="false";
			};
		};
		class ACE: ACE
	...
	class ACE_Knicklicht_Object_G: ACE_Knicklicht_Object_Base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"x\ace\addons\sys_knicklicht\data\grun_ca.paa"
		};
		class MarkerLights
		{
			class RedBlinking
			{
				name="licht";
				color[]={0.1,1,0.1,1};
				ambient[]={0.0099999998,0.1,0.0099999998,0.050000001};
				brightness=0.0027999999;
				blinking="false";
			};
		};
	...
	class ACE_Knicklicht_Object_W: ACE_Knicklicht_Object_Base
	{
		...
		class MarkerLights
		{
			class RedBlinking
			{
				name="licht";
				color[]={1,1,1,1};
				ambient[]={0.1,0.1,0.1,0.050000001};
				brightness=0.0027999999;
				blinking="false";
			};
		};
	...
	class ACE_Knicklicht_Object_Y: ACE_Knicklicht_Object_Base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"x\ace\addons\sys_knicklicht\data\gelb_ca.paa"
		};
		class MarkerLights
		{
			class RedBlinking
			{
				name="licht";
				color[]={1,1,0,1};
				ambient[]={0.1,0.1,0.0099999998,0.050000001};
				brightness=0.0027999999;
				blinking="false";
			};
		};
	...
	class ACE_Knicklicht_Object_B: ACE_Knicklicht_Object_Base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"x\ace\addons\sys_knicklicht\data\blau_ca.paa"
		};
		class MarkerLights
		{
			class RedBlinking
			{
				name="licht";
				color[]={0,0,1,1};
				ambient[]={0.0099999998,0.0099999998,0.1,0.050000001};
				brightness=0.0027999999;
				blinking="false";
			};
		};
	...
	class ACE_Knicklicht_Object_IR: ACE_Knicklicht_Object_Base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"x\ace\addons\sys_knicklicht\data\ir_ca.paa"
		};
		class MarkerLights
		{
			class RedBlinking
