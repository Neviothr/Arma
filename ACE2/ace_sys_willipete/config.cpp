...
class CfgAmmo
{
	...
	class ACE_M34: GrenadeHand
	{
		...
		soundDefault1[]=
		{
			"\x\ace\addons\sys_willipete\wp_exp1.wss",
			3.1622801,
			1,
			900
		};
		soundDefault2[]=
		{
			"\x\ace\addons\sys_willipete\wp_exp2.wss",
			3.1622801,
			1,
			900
		};
		...
		ACE_FRAG_FORCE=0.69999999;
		ACE_FRAG_MULTIPLIER=0.60000002;
	};
...
class CfgWeapons
{
	...
	class Throw: GrenadeLauncher
	{
		...
		class ACE_WPMuzzle: ThrowMuzzle
		{
			...
			sound[]=
			{
				"\x\ace\addons\sys_willipete\grenade_pin.wss",
				0.177828,
				1,
				20
			};
...
class CfgCloudlets
{
	...
	class ACE_WPCloud: Default
	{
		...
		timerPeriod=1;
		lifeTime=90;
		moveVelocity[]={0.075000003,0.1,0.075000003};
		rotationVelocity=1;
		weight=1.275;
		volume=1;
		rubbing=0.0024999999;
		...
		lifeTimeVar=4;
		positionVar[]={4,3,4};
		MoveVelocityVar[]={0.075000003,1.75,0.075000003};
	...
	class ACE_WPCloud2: ACE_WPCloud
	{
		...
		lifeTimeVar=3;
		positionVar[]={3,2,3};
		MoveVelocityVar[]={0.050000001,1.5,0.050000001};
		rotationVelocityVar=1;
		sizeVar=0.1;
	};
