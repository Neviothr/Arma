...
class CfgAmmo
{
	...
	class ace_arty_baseEject: ShellBase
	{
		...
		soundHit[]=
		{
			"\x\ace\addons\sys_arty_ammunition\Sounds\base_eject",
			56.234131,
			1,
			1800
		};
	...
	class ace_arty_60mm_m721_m766_flare: FlareBase
	{
		...
		lightColor[]={0.80000001,0.80000001,0.80000001,0};
		deflecting=65;
	};
...
class CfgMagazines
{
	...
	class ace_arty_60mm_m720a1: ace_arty_60mm_default
	{
		...
		{
			"ace_arty_60mm_m720a1_m734_pd",
			"ace_arty_60mm_m720a1_m734_prox",
			"ace_arty_60mm_m720a1_m734_nsb",
			"ace_arty_60mm_m720a1_m734_delay"
		};
	...
	class ace_arty_60mm_m722a1: ace_arty_60mm_default
	{
		...
		ACE_ARTY_AMMO_CLASSES[]=
		{
			"ace_arty_60mm_m722a1_m745_pd"
		};
		ACE_ARTY_MINCHARGE=0;
		ACE_ARTY_MAXCHARGE=4;
		ACE_ARTY_INEFFECT="WP";
		ACE_Weight=1.6799999;
	};
	...
	class ace_arty_81mm_m821a2: ace_arty_81mm_default
	{
		...
		ACE_ARTY_AMMO_CLASSES[]=
		{
			"ace_arty_81mm_m821a2_m734_pd",
			"ace_arty_81mm_m821a2_m734_prox",
			"ace_arty_81mm_m821a2_m734_nsb",
			"ace_arty_81mm_m821a2_m734_delay"
		};
		ACE_ARTY_MINCHARGE=0;
		ACE_ARTY_MAXCHARGE=4;
		ACE_ARTY_INEFFECT="HE";
	...
	class ace_arty_81mm_m853a1: ace_arty_81mm_default
	{
		...
		ACE_ARTY_AMMO_CLASSES[]=
		{
			"ace_arty_81mm_m853a1_m772_time"
		};
		ACE_ARTY_MINCHARGE=1;
		ACE_ARTY_MAXCHARGE=4;
		ACE_ARTY_INEFFECT="ILLUM";
	...
	class ace_arty_81mm_m375a3: ace_arty_81mm_default
	{
		...
		ACE_ARTY_AMMO_CLASSES[]=
		{
			"ace_arty_81mm_m375a3_m524_pd"
		};
		ACE_ARTY_MINCHARGE=0;
		ACE_ARTY_MAXCHARGE=4;
		ACE_ARTY_INEFFECT="WP";
		ACE_Weight=4.2399998;
	};
	...
	class ace_arty_105mm_m1: ace_arty_105mm_default
	{
		...
		ACE_ARTY_AMMO_CLASSES[]=
		{
			"ace_arty_105mm_m1_m782_pd",
			"ace_arty_105mm_m1_m782_prox",
			"ace_arty_105mm_m1_m782_time",
			"ace_arty_105mm_m1_m782_delay"
		};
		ACE_ARTY_MINCHARGE=1;
...
class CfgCloudlets
{
	...
	class ace_arty_105mm_m84a1_m782_smokeCanisterHC_cloudlet2: ace_arty_105mm_m84a1_m782_smokeCanisterHC_cloudlet1
	{
		...
		color[]=
		{
			...
			{0.89999998,0.89999998,0.89999998,0.75},
			{0.89999998,0.89999998,0.89999998,0.5},
			{0.89999998,0.91000003,0.89999998,0.25},
			{1,1,1,0}
		};
	};
	class Default;
...
class ace_arty_ammoprep_RscListBox
{
	...
	colorSelect2[]={0.94999999,0.94999999,0.94999999,1};
	colorSelectBackground[]={0,0,0,1};
	colorSelectBackground2[]={0.54299998,0.57419997,0.4102,1};
	period=1.2;
...
class ace_arty_ammoprep_CheckBox
{
	...
	coloSelectedBg[]={0.40000001,0.40000001,0.40000001,1};
	font="Zeppelin32";
	sizeEx="0.015*SafeZoneH";
	rows=1;
	columns=2;
