class CfgPatches
{
	class ace_sys_goggles
	{
		...
		weapons[]=
		{
			...
			"ACE_GlassesGasMask_S10",
			"ACE_GlassesGasMask_RU",
			"ACE_GlassesBalaklava",
			"ACE_GlassesBalaklava_Skull",
			"ACE_GlassesBalaklava_Pink",
			"ACE_GlassesBalaklavaOlive",
			"ACE_GlassesBalaklavaGray",
			"ACE_GlassesDelta_glasses"
		};
...
class CfgSounds
{
	class ACE_Dull1
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_goggles\sound\us_deaf_alt1.ogg",
			"db+8",
			1
		};
		titles[]={};
	...
	class ACE_Dull2: ACE_Dull1
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_goggles\sound\us_deaf_alt2.ogg",
			"db+8",
			1
		};
	};
