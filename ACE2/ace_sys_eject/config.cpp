class CfgPatches
{
	class ace_sys_eject
	{
		...
		{
			"ACE_Ka52_Blade",
			"ACE_EjectionSeatBase",
			"ACE_ACESII",
			"ACE_K36",
			"ACE_MB_Mk12",
			"ACE_UsedPara_Base",
			"ACE_UsedParachute_MC5",
			"ACE_UsedParachute_Round"
		};
		weapons[]=
		{
			"ACE_ParachutePack",
...
class CfgVehicles
{
	...
	class ACE_EjectionSeat: Motorcycle
	{
		...
		soundEnviron[]=
		{
			"\Ca\sounds\Air\Noises\padak_let",
			0.316228,
			1.25,
			80
		};
		soundCrash[]=
		{
			"\Ca\sounds\Air\Noises\padak_dopad",
			0.031622801,
			1.125,
			50
		};
		...
		soundWaterCrash[]=
		{
			"\Ca\sounds\Air\Noises\padak_dopadvoda",
			3.1622801,
			1.125,
			80
		};
...
class CfgSounds
{
	class ACE_EjectionSeat
	{
		sound[]=
		{
			"\x\ace\addons\sys_eject\sound\EjectionSeat.ogg",
			7,
			1
		};
	...
	class ChuteOpen
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_eject\sound\ChuteOpen.ogg",
			"db+15",
			1
		};
		titles[]={};
	...
	class SkyDiveWind
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_eject\sound\SkyDiveWind.ogg",
			"db+100",
			1
		};
		titles[]={};
	...
	class ChuteFlutter2
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_eject\sound\ChuteFlutter2.ogg",
			"db+4",
			1
		};
		titles[]={};
	...
	class ParaLand
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_eject\sound\ParaLand.ogg",
			"db-6",
			1
		};
		titles[]={};
	...
	class ParaLandinWater
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_eject\sound\ParaLandinWater.ogg",
			"db-6",
			1
		};
		titles[]={};
	...
	class ACE_Altimeter_HALO
	{
		...
		class controls
		{
			class Alt
			{
				...
				colorBackground[]={0.2,0.15000001,0.1,0};
				colorText[]={1,1,1,1};
			};
			class Compass: Alt
			{
