...
class CfgSounds
{
	class ace_switch_met_1
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_weaponselect\sound\firemodeswitch_met1.wav",
			5,
			1
		};
		titles[]={};
	...
	class ace_switch_met_2
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_weaponselect\sound\firemodeswitch_met2.wav",
			5,
			1
		};
		titles[]={};
	...
	class ace_switch_pla_1
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_weaponselect\sound\firemodeswitch_pla1.wav",
			5,
			1
		};
		titles[]={};
	...
	class ace_switch_pla_2
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_weaponselect\sound\firemodeswitch_pla2.wav",
			5,
			1
		};
		titles[]={};
