...
class CfgMovesMaleSdr: CfgMovesBasic
{
	class States
	{
		...
		class AmovPercMstpSrasWrflDnon_Steady: AmovPercMstpSrasWrflDnon
		{
			...
			aimPrecision=0.38999999;
			aiming="aimingLying";
			camshakefire=0.40000001;
			speed=0.0099999998;
			onLandEnd=1;
			onLandBeg=1;
			connectTo[]=
			{
				"AmovPercMstpSrasWrflDnon_Steady",
				0.02
			};
			connectFrom[]=
			{
		...
		class AmovPknlMstpSrasWrflDnon_Steady: AmovPknlMstpSrasWrflDnon
		{
			...
			aimPrecision=0.19499999;
			aiming="aimingLying";
			camshakefire=0.34999999;
			onLandEnd=1;
			onLandBeg=1;
			connectTo[]=
			{
				"AmovPknlMstpSrasWrflDnon_Steady",
				0.02
			};
			connectFrom[]=
			{
		...
		class AmovPpneMstpSrasWrflDnon_Bipod: AmovPpneMstpSrasWrflDnon
		{
			...
			aimPrecision=0.094999999;
			aiming="ACE_aimingBipod";
			camshakefire=0.30000001;
			onLandEnd=1;
			onLandBeg=1;
			connectTo[]=
			{
				"AmovPpneMstpSrasWrflDnon_Bipod",
				0.02
			};
			connectFrom[]=
			{
...
class CfgSounds
{
	class ace_deployweapon_1
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_weaponrest\sound\depl1.ogg",
			5,
			1
		};
		titles[]={};
	...
	class ace_deployweapon_2
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_weaponrest\sound\depl2.ogg",
			5,
			1
		};
		titles[]={};
	...
	class ace_deployweapon_3
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_weaponrest\sound\depl3.ogg",
			5,
			1
		};
		titles[]={};
