...
class CfgVehicles
{
	...
	class HMMWV_M1151_M2_DES_Base_EP1: HMMWV_Base
	{
		...
		class Turrets: Turrets
		{
			class MainTurret: MainTurret
			{
				...
				soundServo[]=
				{
					"\x\ace\addons\c_vehicle\data\sound\turret_servo.ogg",
					0.0099999998,
					1,
					10
				};
	...
	class UAZ_Unarmed_Base: UAZ_Base
	{
		...
		class Damage
		{
			mat[]=
			{
				"Ca\wheeled_E\UAZ\Data\uaz_main_metal.rvmat",
				"Ca\wheeled_E\UAZ\Data\uaz_main_metal_damage.rvmat",
				"Ca\wheeled_E\UAZ\Data\uaz_main_metal_destruct.rvmat",
				"Ca\wheeled_E\UAZ\Data\uaz_other_metal.rvmat",
				"Ca\wheeled_E\UAZ\Data\uaz_other_metal_damage.rvmat",
				"Ca\wheeled_E\UAZ\Data\uaz_other_metal_destruct.rvmat",
				"Ca\wheeled_E\UAZ\Data\uaz_mount.rvmat",
				"Ca\wheeled_E\UAZ\Data\uaz_mount_damage.rvmat",
				"Ca\wheeled_E\UAZ\Data\uaz_mount_destruct.rvmat",
				"Ca\wheeled_E\UAZ\Data\uaz_skla.rvmat",
				"Ca\wheeled_E\Data\auta_skla_damage.rvmat",
				"Ca\wheeled_E\Data\auta_skla_damage.rvmat",
				"Ca\wheeled_E\UAZ\Data\uaz_skla_in.rvmat",
				"Ca\wheeled_E\Data\auta_skla_in_damage.rvmat",
				"Ca\wheeled_E\Data\auta_skla_in_damage.rvmat",
				"ca\weapons\data\dshk.rvmat",
				"ca\weapons\data\dshk_damage.rvmat",
	...
	class ACE_UAZ_SPG9_CDF: UAZ_SPG9_INS
	{
		...
		hiddenSelectionsTextures[]=
		{
			...
			"\ca\wheeled\data\uaz_mount_002_co.paa"
		};
	};
	class ACE_UAZ_MG_RU: UAZ_MG_INS
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\ca\wheeled\data\Uaz_main_CO.paa",
			"\ca\wheeled\data\uaz_mount_co.paa"
		};
	};
	...
	class ACE_Offroad_SPG9_INS: Offroad_SPG9_Gue
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\ca\wheeled\hilux_armed\data\coyota_trup1_CO.paa"
		};
	};
	...
	class LAV25_Base: Wheeled_APC
	{
		...
		maxSpeed=110;
		fuelCapacity=269;
		threat[]={0.89999998,0.2,0.69999999};
		armor=150;
		...
		class Turrets: Turrets
		{
			class MainTurret: MainTurret
			{
				...
				maxHorizontalRotSpeed=0.79000002;
				stabilizedInAxes=3;
				gunnerForceOptics=1;
				forceHideGunner=0;
				inGunnerMayFire=1;
	...
	class M1135_ATGMV_EP1: StrykerBase_EP1
	{
		...
		armor=150;
		threat[]={0.30000001,1,0.30000001};
		class Turrets: Turrets
		{
			class MainTurret: MainTurret
			{
	...
	class BTR60_TK_EP1: BRDM2_Base
	{
		...
		maxSpeed=77;
		fuelCapacity=290;
		threat[]={1,0.30000001,0.60000002};
		radarType=0;
		class ViewOptics
		{
			initFov="0.33333+ 0.41667";
	...
	class GAZ_Vodnik_HMG: Wheeled_APC
	{
		...
		maxSpeed=119;
		fuelCapacity=144;
		threat[]={1,0.30000001,0.69999999};
		armor=40;
		armorStructural=3;
		driverForceOptics=0;
		forceHideDriver=1;
	...
	class BTR90_Base: Wheeled_APC
	{
		...
		threat[]={1,0.69999999,0.69999999};
		armor=200;
		armorStructural=3.25;
		damageResistance=0.024320001;
		driverForceOptics=0;
		...
		class Turrets: Turrets
		{
			class MainTurret: MainTurret
			{
				...
				magazines[]=
				{
					...
					"2Rnd_TOW2",
					"2Rnd_TOW2",
					"ACE_1100Rnd_762x51_M240",
					"ACE_1100Rnd_762x51_M240",
					"ACE_230Rnd_25mm_M242_HEI",
					"ACE_230Rnd_25mm_M242_HEI",
					"ACE_230Rnd_25mm_M242_HEI",
					"ACE_70Rnd_25mm_M242_APFSDS",
					"ACE_70Rnd_25mm_M242_APFSDS",
					"ACE_70Rnd_25mm_M242_APFSDS"
				};
				radarType=4;
	...
	class M2A2_EP1: M2A2_Base
	{
		...
		hiddenselectionstextures[]=
		{
			"\ca\tracked_e\m2a2_bradley\data\base_co.paa",
			"\ca\tracked_e\m2a2_bradley\data\a3_co.paa",
			"\ca\tracked_e\m2a2_bradley\data\ultralp_co.paa",
			"",
			"\ca\tracked_e\m2a2_bradley\data\base_co.paa"
		};
		class AnimationSources
	...
	class M1A1: Tank
	{
		...
		class Turrets: Turrets
		{
			class MainTurret: MainTurret
			{
				...
				magazines[]=
				{
					"ACE_25Rnd_120mmSABOT_M1A2",
					"ACE_15Rnd_120mmHE_M1A2",
					"1200Rnd_762x51_M240",
					"1200Rnd_762x51_M240",
					"1200Rnd_762x51_M240",
					"1200Rnd_762x51_M240",
				...
				class Turrets: Turrets
				{
					...
					class CommanderOptics: CommanderOptics
					{
						minElev=-10;
						maxElev=60;
						maxVerticalRotSpeed=0.059999999;
						startengine=0;
						stabilizedInAxes=3;
						commanderForceOptics=1;
						forceHideCommander=0;
	...
	class M1A2_TUSK_MG: M1A1
	{
		...
		class Turrets: Turrets
		{
			class MainTurret: MainTurret
			{
				...
				magazines[]=
				{
					"ACE_30Rnd_120mmSABOT_M1A2",
					"ACE_8Rnd_120mmHE_M1A2",
					"ACE_4Rnd_M1028",
					"1200Rnd_762x51_M240",
					"1200Rnd_762x51_M240",
					"1200Rnd_762x51_M240",
	...
	class T90: Tank
	{
		...
		class Turrets: Turrets
		{
			class MainTurret: MainTurret
			{
				...
				maxElev=14;
				maxHorizontalRotSpeed=0.61000001;
				maxVerticalRotSpeed=0.090000004;
				startEngine=0;
				stabilizedInAxes=3;
				gunnerForceOptics=1;
				gunnerOutOpticsModel="";
				...
				class Turrets: Turrets
				{
					class CommanderOptics: NewTurret
					{
						...
						startEngine=0;
						stabilizedInAxes=3;
						maxVerticalRotSpeed=0.41999999;
						maxHorizontalRotSpeed=0.61000001;
						minElev=-7;
						maxElev=80;
						class OpticsIn
		...
		threat[]={0.89999998,0.89999998,0.5};
		class Library
		{
	...
	class T72_Base: Tank
	{
		...
		class Reflectors
		{
			...
			{
				ambient[]={0.0099999998,0.0099999998,0.0099999998,0.001};
		...
		class Turrets: Turrets
		{
			class MainTurret: MainTurret
			{
				...
				maxElev=14;
				minElev=-6;
				maxHorizontalRotSpeed=0.31999999;
				maxVerticalRotSpeed=0.059999999;
				startEngine=0;
				stabilizedInAxes=1;
				gunnerForceOptics=1;
				...
				class Turrets: Turrets
				{
					class CommanderOptics: CommanderOptics
					{
						...
						minElev=-5;
						maxElev=45;
						maxVerticalRotSpeed=0.079999998;
						class ViewOptics: ViewOptics
						{
							initFov="0.33333/ 5";
							minFov="0.33333/ 4.2";
	...
	class T34: Tank
	{
		...
		class Turrets: Turrets
		{
			class MainTurret: MainTurret
			{
				...
				minElev=-5;
				maxElev=22;
				maxHorizontalRotSpeed=0.30000001;
				stabilizedInAxes=0;
				gunnerForceOptics=1;
				forceHideGunner=0;
				inGunnerMayFire=1;
		...
		threat[]={0.40000001,0.40000001,0};
	};
	...
	class AH6_Base_EP1: Helicopter
	{
		...
		envelope[]={2.5999999,3.8,5.3000002,6.8000002,8.3000002,8.3000002,7.8000002,7.8000002,7,8,7.8000002,6.3000002,4.8000002,3.2,3.2,1.7};
		accuracy=0.40000001;
		soundincommingmissile[]=
		{
			"\ca\Tracked\Data\Sound\alarm_loop1",
	...
	class AW159_Lynx_BAF: Helicopter
	{
		...
		class MFD
		{
			class AirplaneHUD
			{
				helmetposition[]={-0.025,0.037500001,0.1};
			};
		};
		magazines[]=
		{
	...
	class C130J: Plane
	{
		...
		wheelSteeringSensitivity=4.1999998;
		noseDownCoef=0;
		flapsFrictionCoef=1;
		landingAoa="rad 7";
		landingSpeed=210;
	...
	class ACE_A10_CBU87: A10_US_EP1
	{
		...
		weapons[]=
		{
			...
			"MaverickLauncher",
			"SidewinderLaucher_AH1Z",
			"ACE_CBU87_Bomblauncher",
			"FFARLauncher_14",
			"CMFlareLauncher"
		};
		magazines[]=
		{
			"ACE_1350Rnd_30mmAP_A10",
			"2Rnd_Maverick_A10",
			"2Rnd_Sidewinder_AH1Z",
			"ACE_4Rnd_CBU87",
			"14Rnd_FFAR",
	...
	class Su25_base: Plane
	{
		...
		weapons[]=
		{
			...
			"AirBombLauncher",
			"R73Launcher_2",
			"ACE_S8Launcher_Plane",
			"CMFlareLauncher"
		};
		magazines[]=
		{
			"ACE_250Rnd_30mm_GSh302",
			"4Rnd_FAB_250",
			"2Rnd_R73",
			"40Rnd_S8T",
			"40Rnd_80mm",
	...
	class BIS_alice_emptydoor: Car
	{
		...
		ace_sys_repair_threshold=0.80000001;
...
class CfgMagazines
{
	...
	class ACE_8Rnd_DAGR: 8Rnd_Hellfire
	{
		...
		sound[]=
		{
			"\ca\weapons\Data\Sound\rockets\rocketLauncher_Shot21",
			3.1622801,
			1
		};
	};
...
class CfgAmmo
{
	...
	class B_127x108_APHE: BulletBase
	{
		...
		ace_mass=2.7;
		ace_windcoef=0.36000001;
		ace_incendiary=0.5;
		airFriction=-0.00089999998;
		cost=10;
		explosive=0;
		hit=16;
		indirectHit=0.89999998;
	...
	{
		airFriction=-0.00044500001;
		timetolive=27;
	};
	class G_40mm_HE;
	class ACE_M430Round: G_40mm_HE
	{
		airFriction=-0.00055200001;
		timetolive=40;
		ace_hit=50;
		hit=40;
		ace_heat=1;
	...
	class R_PG9_AT: RocketBase
	{
		...
		timeToLive=6;
		maxspeed=200;
		sideAirFriction=0.47999999;
		initTime=0.02;
		thrustTime=0.55000001;
		thrust=928;
		explosionEffects="GrenadeExplosion";
		CraterEffects="ATRocketCrater";
	};
...
class CfgWeapons
{
	...
	class M252: CannonCore
	{
		magazines[]=
		{
			...
			"ACE_ARTY_1Rnd_81mmHE_M252",
			"ACE_ARTY_1Rnd_81mmWP_M252",
	...
	class 2B14: CannonCore
	{
		magazines[]=
		{
			...
			"ACE_ARTY_1Rnd_82mmHE_2B14",
			"ACE_ARTY_1Rnd_82mmWP_2B14",
			"ACE_ARTY_1Rnd_82mmILLUM_2B14"
		};
		class Single1: Mode_SemiAuto
		{
			dispersion=0.0089999996;
	...
	class M240_veh: MGun
	{
		...
		magazines[]=
		{
			...
			"1200Rnd_762x51_M240",
			"ACE_1100Rnd_762x51_M240",
			"ACE_1000Rnd_762x51_M240",
			"ACE_800Rnd_762x51_M240",
			"ACE_400Rnd_762x51_M240",
			"ACE_200Rnd_762x51_M240",
			"ACE_1500Rnd_762x51_M240"
		};
		class manual: MGun
		{
			autoReload=0;
	...
	class M256: CannonCore
	{
		...
		magazines[]=
		{
			"ACE_25Rnd_120mmSABOT_M1A2",
			"ACE_30Rnd_120mmSABOT_M1A2",
			"ACE_22Rnd_120mmSABOT_M1A2",
			"20Rnd_120mmSABOT_M1A2",
			"ACE_6Rnd_120mmHE_M1A2",
			"ACE_8Rnd_120mmHE_M1A2",
			"ACE_15Rnd_120mmHE_M1A2",
			"20Rnd_120mmHE_M1A2",
			"ACE_4Rnd_M1028",
	...
	class AZP85: CannonCore
	{
		...
		class medium: close
		{
			...
			aiRateOfFire=3;
			minRange=1600;
			minRangeProbab=0.075000003;
			midRange=2200;
			midRangeProbab=0.85000002;
			maxRange=2800;
			maxRangeProbab=0.075000003;
	...
	class 2A42: CannonCore
	{
		...
		magazines[]=
		{
			...
			"230Rnd_30mmHE_2A42",
			"250Rnd_30mmHE_2A42",
			"ACE_120Rnd_30mmHE_2A42",
			"150Rnd_30mmAP_2A42",
			"230Rnd_30mmAP_2A42",
			"250Rnd_30mmAP_2A42",
			"ACE_180Rnd_30mmAP_2A42"
		};
		class LowROF: Mode_FullAuto
		{
			displayName="LO";
	...
	class ACE_2A28_Base: CannonCore
	{
		...
		reloadSound[]=
		{
			"\ca\Sounds\weapons\cannon\gun120reload",
			1,
			1,
			20
		};
		...
		magazines[]=
		{
			"ACE_24Rnd_73mm_PG15V",
			"ACE_16Rnd_73mm_OG15V"
		};
		minRange=5;
		minRangeProbab=0.69999999;
		midRange=600;
	...
	class ACE_HellfireLauncher_Apache: HellfireLauncher
	{
		...
		magazines[]=
		{
			...
			"ACE_6Rnd_Hellfire_L",
			"ACE_8Rnd_Hellfire_L",
			"ACE_10Rnd_Hellfire_L",
			"ACE_12Rnd_Hellfire_L",
			"ACE_14Rnd_Hellfire_L",
			"ACE_16Rnd_Hellfire_L"
		};
	};
	...
	class SidewinderLaucher: MissileLauncher
	{
		...
		lockingTargetSound[]=
		{
			"\x\ace\addons\c_vehicle\data\sound\aim9locktone",
			0.00031622799,
			1.5
		};
		lockedTargetSound[]=
	...
	class ACE_9K31Launcher: MissileLauncher
	{
		...
		sound[]=
		{
			"\Ca\sounds\Weapons\rockets\javelin1_A",
			10,
			1,
			1400
		};
	...
	class GSh301: CannonCore
	{
		...
		magazines[]=
		{
			"180Rnd_30mm_GSh301",
			"750Rnd_30mm_GSh301",
			"ACE_150Rnd_30mm_GSh301",
			"ACE_180Rnd_30mm_GSh301"
		};
		class manual: CannonCore
		{
			displayName="$STR_ACE_WDN_GSH301";
