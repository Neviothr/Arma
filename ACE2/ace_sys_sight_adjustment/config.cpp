...
class ACE_SYS_SA_RscEdit: RscEdit
{
	...
	sizeEx=0.024;
	colorText[]={0,0,0,1};
	colorSelection[]={0.20392001,0.40000001,0.058820002,1};
	autocomplete=0;
	text="";
	shadow=0;
};
...
class ACE_SYS_SA_RNG_Dialog
{
	...
	class InnerDialogFrame: ACE_SYS_SA_MainBack
	{
		...
		h=0.13;
		moving=1;
		colorBackground[]={0.80000001,0.80000001,0.80000001,0.69999999};
		colorBorder[]={0,0,0,1};
		BorderSize=0.003;
	};
	objects[]={};
...
class cfgVehicles
{
	...
	{
		ace_sa_defaultelevation=4.1999998;
	};
};
