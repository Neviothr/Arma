...
class ACE_Button
{
	...
	colorBackgroundActive[]={0.94999999,0.94999999,0.94999999,1};
	colorFocused[]={0.94999999,0.94999999,0.94999999,1};
...
class ACE_LinkButtonBase
{
	...
	colorDisabled[]={0,0,1,0.69999999};
...
class ACE_SettingsDialog
{
	...
	class controls
	{
		...
		class ViewdistanceSliderDisabled: SubCaption_FixHeadbug
		{
			...
			sizeEx=0.025;
			style=2;
			colorText[]={0.87840003,0.84710002,0.65100002,0.69999999};
