...
class ACE_Interaction_Menu
{
	...
	flexiMenu_subMenuCaptionWidth=0.40000001;
...
class CfgSounds
{
	class ACE_Melee1
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_interaction\sound\melee1.ogg",
			"db-10",
			1
		};
		titles[]={};
	...
	class ACE_Melee2
	{
		...
		sound[]=
		{
			"\x\ace\addons\sys_interaction\sound\melee2.ogg",
			"db-10",
			1
		};
		titles[]={};
