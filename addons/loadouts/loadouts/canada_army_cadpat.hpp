class GVAR(r) {
    ...
    linkedItems[] = {"rhsusf_mbav_rifleman", "rhsusf_opscore_aor2", "ItemCompass", "ItemWatch", "ItemRadio"};
    weapons[] = {"rhs_weap_m16a4_carryhandle_pmag"};
    magazines[] = {
...
class GVAR(rat) {
    ...
    backpack = "B_AssaultPack_cbr";
    linkedItems[] = {"rhsusf_mbav_rifleman", "rhsusf_opscore_aor2", "ItemCompass", "ItemWatch", "ItemRadio"};
    weapons[] = {"rhs_weap_m16a4_carryhandle_pmag", "rhs_weap_m72a7"};
    magazines[] = {
        LIST_11("rhs_mag_30Rnd_556x45_M855_Stanag"),
        LIST_2("rhs_mag_30Rnd_556x45_M855_Stanag_Tracer_Red"),
        LIST_2("rhs_mag_m67"),
