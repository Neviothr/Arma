class CfgLoadouts {
    ...
    class us_army_rangers_oefcp_mk17 {
    ...
    class east_european_insurgents_2014 {
    ...
    class bundeswehr_flecktarn {
        #include "loadouts\bundeswehr_flecktarn.hpp"
    };
    class bundeswehr_flecktarn_alt {
    ...
    class afghan_national_police_2005 {
