...
//-------------------------------------------------------------------------------------------------------------------------
	case 0:
	{
		...
		_setSkill   = [[0.05,0.05],[0.01,0.01],[0.01,0.01],[0.2,0.2],[0.5,0.5],[1,1],[1,1],[0.2,0.4],[0.2,0.4],[1,1]];
		...
		_setFleeing = [0,25];
		_setHeliVal = [100,200,1,1];
		_setPause   = [[5,10],[5,10],[5,10],[20,30,5,5],[1,3],[0,0]];
		_setBldgBeh = [3,50,500,60,1];
