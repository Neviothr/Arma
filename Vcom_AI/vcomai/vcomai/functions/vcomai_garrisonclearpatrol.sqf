...
if (_RefinedBuildingArray isEqualTo []) then {
	_ClosestPos = [_Locations, _Enemy] call VCOMAI_ClosestObject;
} else {
	_ClosestPos = [_RefinedBuildingArray, _Enemy] call VCOMAI_ClosestObject;
};
